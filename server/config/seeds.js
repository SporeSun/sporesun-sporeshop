...
db.once('open', async () => {
  ...
  const categories = await Category.insertMany([
    ...
    { name: 'Gourmet and Medicinal Cultures', image: 'https://i.imgur.com/Izp4vM2_d.webp?maxwidth=760&fidelity=grand', description: "Dive into the world of culinary delights with our Gourmet and Medicinal Cultures. From Brown Beech Mushrooms to Lion's Mane, these varieties offer both exquisite flavors and health benefits." },
